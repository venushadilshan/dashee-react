    ...
    return (
        <div className='flex flex-col w-full h-screen  bg-white' >
            ...
            <div className='flex  flex-col mt-14  w-full h-full'>
                <div className='flex flex-row justify-start  items-center w-full text-slate-900 mb-6 pl-10 p-2 hover:bg-fuchsia-200'> <HiHome className='text-2xl' /> <p className='text-md ml-6 mx-10 font-semibold'><Link to="/page">Dashboard</Link></p></div>
